...
public class ThirdYmqySendMsgResult {
    ...
    public ThirdYmqySendMsgResult() {
    }

    public ThirdYmqySendMsgResult(String returnstatus, String message, long remainpoint, String taskID, long successCounts) {
