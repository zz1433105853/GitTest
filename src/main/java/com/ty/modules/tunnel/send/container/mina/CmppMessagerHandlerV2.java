 ...
 */
public class CmppMessagerHandlerV2 extends AbstractCmppMessageHandler {

    private static Logger logger= Logger.getLogger(CmppMessagerHandlerV2.class);


    public CmppMessagerHandlerV2(
            ...
            if(message!=null){
                ...
                switch ((int)msgHead.getCommandId()) {
                    case MsgCommand.CMPP_CONNECT_RESP:
                        MsgConnectRespV2 msgConnectResp=(MsgConnectRespV2) message;
                    ...
                    case MsgCommand.CMPP_SUBMIT_RESP:
                        MsgSubmitRespV2 msgSubmitResp= (MsgSubmitRespV2) message;
                        if(messageContainer.getWindowMap().containsKey(String.valueOf(msgSubmitResp.getSequenceId()))) {
                            ...
                            CmppMessageSendV2 messageSend = (CmppMessageSendV2) messageContainer.getWindowMap().get(keyNow);
                    ...
                    case MsgCommand.CMPP_DELIVER:
                        MsgDeliverV2 msgDeliver=(MsgDeliverV2) message;
                    ...
                    case MsgCommand.CMPP_QUERY_RESP:
                        ...
                        logger.info(messageContainer.getTdName()+"收到短信查询响应，响应内容:"+ JsonMapper.toPrettyJsonStr(msgQueryResp));
                        break;
                    ...
                    case MsgCommand.CMPP_ACTIVE_TEST_RESP:
                        ...
                        logger.info(messageContainer.getTdName()+"收到链路检测响应，响应内容:"+ JsonMapper.toPrettyJsonStr(msgActiveTestResp));
