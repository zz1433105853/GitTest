...
public class ThirdYmqyBalanceResult {
    ...
    public ThirdYmqyBalanceResult() {
    }

    public ThirdYmqyBalanceResult(String returnstatus, String message, long overage, String payinfo, long sendTotal) {
