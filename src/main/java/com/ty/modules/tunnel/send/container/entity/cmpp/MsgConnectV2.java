...
* @date:2016下午02:21:19
 */
public class MsgConnectV2 extends MsgHead{
	private static Logger logger= Logger.getLogger(MsgConnectV2.class);
	...
	private byte version=0x20;				//双方协商的版本号(高位4bit表示主版本号,低位4bit表示次版本号)，对于3.0的版本，高4bit为3，低4位为0
	...
	public static MsgConnectV2 toObject(MsgHead msgHead, IoBuffer in){
		MsgConnectV2 msgConnect=new MsgConnectV2();
		try {
