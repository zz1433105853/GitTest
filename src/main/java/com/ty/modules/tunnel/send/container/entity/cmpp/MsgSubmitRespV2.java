...
* @date:2016下午03:08:09
 */
public class MsgSubmitRespV2 extends MsgHead {
	private static Logger logger= Logger.getLogger(MsgSubmitRespV2.class);
	private long msgId;
	...
	public static MsgSubmitRespV2 toObject(MsgHead msgHead, IoBuffer in){
		MsgSubmitRespV2 msgSubmitResp=new MsgSubmitRespV2();
		...
		msgSubmitResp.setResult(in.get());
