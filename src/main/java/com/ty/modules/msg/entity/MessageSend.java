...
public class MessageSend extends DataEntity<MessageSend> {
    private static final long serialVersionUID = 2018548578305440006L;
    ...
    private List<MsgRecord> reSendLogList;
    ...
    public List<MsgRecord> getReSendLogList() {
        return reSendLogList;
    }

    public void setReSendLogList(List<MsgRecord> reSendLogList) {
        this.reSendLogList = reSendLogList;
    }
