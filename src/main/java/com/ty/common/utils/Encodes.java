...
//	}
	...
	public static String urlEncode(String part,String code) {
		try {
			return URLEncoder.encode(part, code);
		} catch (UnsupportedEncodingException e) {
			throw Exceptions.unchecked(e);
		}
	}
	 ...
	 * URL 解码
	 */
	public static String urlDecode(String part,String code) {

		try {
			return URLDecoder.decode(part, code);
		} catch (UnsupportedEncodingException e) {
			throw Exceptions.unchecked(e);
		}
	}
