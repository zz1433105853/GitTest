...
//	@SuppressWarnings("unchecked")
	...
	// File file =
	// SendMail.class.getClassLoader().getResource("mailtemplate/modules.ftl").getFile();
	// return file;
	// }
	//
	...
	public static void main(String[] args) {
		...
		// hemail.setSubject("sendemail modules!");
		...
		String templatePath = "mailtemplate/modules.ftl";
		sendFtlMail("modules@163.com", "sendemail modules!", templatePath, map);

		// System.out.println(getFileName("mailtemplate/modules.ftl"));
	}
