...
public class MsgConnectResp extends MsgHead {
	...
	private byte version=0x30;				//服务器支持的最高版本号，对于3.0的版本，高4bit为3，低4位为0
	
	
	public static MsgConnectResp toObject (MsgHead msgHead,IoBuffer in){
 		MsgConnectResp msgConnectResp=new MsgConnectResp();
		...
		msgConnectResp.setStatus(in.getUnsignedInt());
