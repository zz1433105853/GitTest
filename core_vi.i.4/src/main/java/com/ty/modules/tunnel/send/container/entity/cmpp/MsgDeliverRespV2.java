...
* @date:2016下午03:01:56
 */
public class MsgDeliverRespV2 extends MsgHead {
	private static Logger logger= Logger.getLogger(MsgDeliverRespV2.class);
	...
	public static MsgDeliverRespV2 toObject(MsgHead msgHead, IoBuffer in){
		...
		msgDeliverResp.setResult(in.get());
