...
* @date:2016下午05:30:03
 */
public class ClientEncoder extends AbstractClientEncoder{
	private final static Log logger = LogFactory.getLog(ClientEncoder.class);
	...
	public void encode(IoSession session, Object message, ProtocolEncoderOutput out)throws Exception {
		...
		switch((int)msgHead.getCommandId()){
			case MsgCommand.CMPP_CONNECT:
				MsgConnect msgConnect=(MsgConnect) message;
			...
			case MsgCommand.CMPP_SUBMIT:
				MsgSubmit msgSubmit=(MsgSubmit) message;
			...
			case MsgCommand.CMPP_DELIVER_RESP:
				MsgDeliverResp msgDeliverResp=(MsgDeliverResp) message;
